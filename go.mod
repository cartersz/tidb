...
replace github.com/tikv/client-go/v2 => github.com/ekexium/client-go/v2 v2.0.0-alpha.0.20220815031756-3b5d694305ae

replace github.com/pingcap/kvproto => github.com/ekexium/kvproto v0.0.0-20220808040658-ffa2be4b6876
