...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal, Name: TiDBGCRunInterval, Value: "1m0s", Type: TypeDuration, MinValue: int64(time.Minute * 1), MaxValue: uint64(time.Hour * 24 * 365), GetGlobal: func(s *SessionVars) (string, error) {
		return getTiDBTableValue(s, "tikv_gc_run_interval", "1m0s")
	}, SetGlobal: func(s *SessionVars, val string) error {
		return setTiDBTableValue(s, "tikv_gc_run_interval", val, "GC run interval, at least 10m, in Go format.")
	}},
	{Scope: ScopeGlobal, Name: TiDBGCLifetime, Value: "1m0s", Type: TypeDuration, MinValue: int64(time.Minute * 1), MaxValue: uint64(time.Hour * 24 * 365), GetGlobal: func(s *SessionVars) (string, error) {
		return getTiDBTableValue(s, "tikv_gc_life_time", "1m0s")
	}, SetGlobal: func(s *SessionVars, val string) error {
